...
RUN apt-get update --fix-missing && \
    ...
    conda install mamba -c conda-forge && mamba install --channel "conda-forge" --channel "anaconda" --channel "r" python=3.6 r-base=4.0.3 tensorflow keras jupyter jupytext numpy pandas r-devtools r-rgl r-xml gxx_linux-64 libxml2 pandoc r-rjava r-magick gfortran_linux-64 && echo "options(repos=structure(c(CRAN='http://cran.r-project.org')))" >> ~/.Rprofile
