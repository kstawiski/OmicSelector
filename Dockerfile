...
RUN apt-get update --fix-missing && \
    ...
    conda install mamba -c conda-forge && mamba install --channel "conda-forge" --channel "anaconda" --channel "r" python=3.6 r-base=4.0.2 tensorflow keras jupyter jupytext numpy pandas r-devtools r-rgl r-nlme r-xml gxx_linux-64 libxml2 pandoc r-rjava r-magick gfortran_linux-64 libgit2 mesa-libgl-cos6-x86_64 libglu mesa opencv freetype libx11-devel-cos6-x86_64 freeglut xorg-libx11 cairo fortran-compiler && echo "options(repos=structure(c(CRAN='http://cran.r-project.org')))" >> ~/.Rprofile
