...
RUN apt-get update --fix-missing && \
    ...
    conda install mamba -c conda-forge && mamba install --channel "conda-forge" --channel "anaconda" --channel "r" python=3.6 r-base tensorflow-gpu keras jupyter jupytext numpy pandas r-devtools gxx_linux-64 libxml2 pandoc r-rjava r-magick gfortran_linux-64 libglu libx11-devel-cos6-x86_64 libgit2 xorg-libx11 mesa-libgl-cos6-x86_64 mesa opencv freeglut freetype cairo fortran-compiler && echo "options(repos=structure(c(CRAN='http://cran.r-project.org')))" >> ~/.Rprofile
