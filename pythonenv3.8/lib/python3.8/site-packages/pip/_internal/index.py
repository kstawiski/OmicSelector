...
class LinkEvaluator(object):
    ...
    def __init__(
        ...
        :param ignore_requires_python: Whether to ignore incompatible
            PEP 503 "data-requires-python" values in HTML linOmicSelector_ Defaults
            to False.
        """
...
class PackageFinder(object):
    ...
    packages, by reading pages and looking for appropriate linOmicSelector_
    """
    ...
    def __init__(
        ...
        :param format_control: A FormatControl object, used to control
            ...
            the index and linOmicSelector_
    ...
    def find_all_candidates(self, project_name):
        ...
        This checks index_urls and find_linOmicSelector_
        ...
        #   via --index-url or --find-linOmicSelector_
    ...
    def _log_skipped_link(self, link, reason):
        ...
        if link not in self._logged_links:
            ...
            self._logged_linOmicSelector_add(link)
