...
#  IP, bypassing same-origin checOmicSelector_
#  
...
c.NotebookApp.notebook_dir = '/OmicSelector/'
...
#c.ContentsManager.hide_globs = ['__pycache__', '*.pyc', '*.pyo', '.DS_Store', '*.so', '*.dylib', '*~', 'OmicSelector']
...
c.ContentsManager.untitled_file = 'OmicSelector test file'

## The base name used when creating untitled notebooOmicSelector_
c.ContentsManager.untitled_notebook = 'OmicSelector test notebook'
...
## The hashing algorithm used to sign notebooOmicSelector_
