...
predtrain_y = predict(bestmodel, train, type="prob")[,"Cancer"]
predtrain = predict(bestmodel, train)
caret::confusionMatrix(predtrain, train$Class, positive = "Cancer")
...
```{r echo = FALSE, message = FALSE, warning = FALSE}
pred_y = predict(bestmodel, test, type="prob")[,"Cancer"]
pred = predict(bestmodel, test)
caret::confusionMatrix(pred, test$Class, positive = "Cancer")
```

Metrics on validation set:

```{r echo = FALSE, message = FALSE, warning = FALSE}
pred_y = predict(bestmodel, valid, type="prob")[,"Cancer"]
pred = predict(bestmodel, valid)
caret::confusionMatrix(pred, valid$Class, positive = "Cancer")
```
