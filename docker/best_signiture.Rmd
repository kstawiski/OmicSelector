...
colnames(model_results) = c("Name", "ID", "Selection Method","Modelling Method","Train ROC AUC", "Train Acc", "Test Acc", "Valid Acc", "Metaindex")
...
# Top 3 models
OmicSelector_table(model_results[1:10,]) 
```