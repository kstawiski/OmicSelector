# Tests for Paper 3 miRNA alias resolver (paper3-mirna-name-resolver.R).
# Run via:
#   Rscript -e 'source("R/paper3-mirna-name-resolver.R"); \
#               testthat::test_file("tests/testthat/test-paper3-mirna-name-resolver.R", \
#                                   reporter="minimal")'
