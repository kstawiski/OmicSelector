...
paper3_method_bank <- function() {
  rows <- list(
    ...
    .p3_row("J", "subtype-stratified matched random panels", NA, "paper3_matched_null_benchmark_cv", "auxiliary"),
    .p3_row("J", "LOCO splits with same-block exclusion", NA, "paper3_make_loco_splits", "auxiliary"),
    .p3_row("J", "LOCTO splits with same-block exclusion", NA, "paper3_make_locto_splits", "auxiliary"),
    .p3_row("J", "provenance pre-flight gate", NA, "os_provenance_preflight", "auxiliary"),
    .p3_row("J", "block-aware Brown/Kost BH", NA, "paper3_bh_fdr_correct_blocked", "auxiliary"),
...
#'
#' @param bank Optional registry returned by [paper3_method_bank()].
...
#' @export
paper3_assert_method_bank_exports <- function(bank = paper3_method_bank(),
                                              allow_deferred = TRUE) {
  required <- bank
...
#' @export
paper3_make_loco_splits <- function(sample_meta,
                                    cohort_col = "cohort",
...
#' @inheritParams paper3_make_loco_splits
#' @return A list of split objects with train/test indices and status.
#' @export
paper3_make_locto_splits <- function(sample_meta,
...
#' @name paper3_advanced_scorers
NULL

#' @rdname paper3_advanced_scorers
#' @export
