#' @title Paper 3 preprocessing utilities
#'
#' @description
#' Preprocessing helpers introduced in Paper 3 of the OmicSelector programme
#' (Stawiski et al., in preparation). Currently provides inverse-log
