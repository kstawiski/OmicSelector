...
FrozenComBat prevents batch correction leakage by fitting parameters only on
training data and applying frozen transformations to test data. The pipeline
handles this automatically when `batch_correct = TRUE`.
...
On TCGA kidney cancer, KS filter discovered the **miR-200/miR-141 family**
(EMT regulators) that ANOVA missed.
