...
- **Konrad Stawiski**. Author, maintainer.
  [](https://orcid.org/0000-0002-6550-3384)

- **Marcin Kaszkowiak**. Author.

- **Damian Mikulski**. Author.

## Citation

Source:
[`DESCRIPTION`](https://github.com/kstawiski/OmicSelector/blob/HEAD/DESCRIPTION)
...
version 2.4.0, <https://github.com/kstawiski/OmicSelector>.
