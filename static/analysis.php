...
<?php } else { ?>
  <div class="panel panel-success">
            ...
            <div class="panel-body">
              ...
              <br /><font size="1">Notes: This table presents final formulas. <a href="https://kstawiski.github.io/OmicSelector/reference/OmicSelector_merge_formulas.html" target="_blank">The formulas with features more than the prefered number of features of features were trimmed (according to documentation).</a> Using the download button you can download filtered set.</font><br></p>
